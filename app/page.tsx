...
export default function Home() {
  return <main className="home-page">
    ...
    <section className="home-menu-invite"><div className="home-menu-invite-copy"><p className="home-kicker home-kicker-light">O sabor também faz parte da festa</p><h2>Uma experiência<br /><em>à mesa.</em></h2><p>Da primeira mordida ao último brinde, os sabores também fazem parte das memórias. Descubra cardápios pensados para surpreender e combinar com o jeito da sua celebração.</p><a className="home-button home-button-pink" href="/cardapios">Conheça os cardápios <Arrow /></a></div><figure className="home-menu-invite-image"><img src="/media/cardapio-imperial.webp" alt="Finger foods do cardápio Imperial do Sonho de Criança" /><figcaption>Cardápio Imperial</figcaption></figure></section>
